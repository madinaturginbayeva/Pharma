...
public class FXMLInsertPageController {
    ...
    @FXML
    private TextField RemainingDay_text;
    ...
    private void doneButtonAction(ActionEvent event) throws IOException {
        ...
        String query = "INSERT INTO Tasks (Name,RemainingDay,NOTES,TIMING) VALUES (" + "'" + Name_text.getText() + 
                "'," + "'" + RemainingDay_text.getText() + "'," + "'" + notes_text.getText() + "'," + "'" +
    ...
    public void setRemainingDay(String RemainingDay){
        RemainingDay_text.setText(RemainingDay);
    }

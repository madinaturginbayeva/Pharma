...
public class FXMLViewPageController implements Initializable {
    ...
    private void getTasks(ObservableList items, String orderby, String ascdesc){
        ...
        while ( rs.next() ) {
            ...
            String RemainingDay = rs.getString("RemainingDay");
            ...
            items.add(Name + s + RemainingDay + "\t\t\t\t\t" + timing);
         }
        rs.close();
        stmt.close();
        c.close();
    ...
    private void editButtonAction(ActionEvent event) throws IOException{
        ...
        try {
            ...
            while ( rs.next() ) {
                ...
                RemainingDay_text = rs.getString("RemainingDay");
        ...
        controller.setName(Name_text);
        controller.setRemainingDay(RemainingDay_text);
